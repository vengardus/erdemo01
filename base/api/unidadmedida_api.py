...
def unidadmedida_controller(request):
...
class ControllerCustom(Controller):
    ...
    def __init__(self, data, request):
        ...
        self.set_actions()
        self.url_action_new = 'unidadmedida_form'
    ...
    def action_refresh(self):
        ...
        oBModel.get_all(self.request.user.license_id)
        self.context['aDataTable'] = oBModel.get_aTO_toArray()
        self.context['action_new'] = reverse(self.url_action_new, args=['new', 0]); #'unidadmedida_form'
